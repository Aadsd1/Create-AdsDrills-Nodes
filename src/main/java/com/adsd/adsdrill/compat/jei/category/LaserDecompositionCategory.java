...
import com.adsd.adsdrill.compat.jei.recipe.LaserDecompositionRecipe;
...
public class LaserDecompositionCategory implements IRecipeCategory<LaserDecompositionRecipe> {
    ...
    public static final RecipeType<LaserDecompositionRecipe> TYPE = RecipeType.create(AdsDrillAddon.MOD_ID, "laser_decomposition", LaserDecompositionRecipe.class);
    ...
    public LaserDecompositionCategory(IGuiHelper helper) {
        ...
        icon = helper.createDrawableItemStack(new ItemStack(AdsDrillBlocks.LASER_DRILL_HEAD.get()));
    ...
    @Override public @NotNull Component getTitle() { return Component.translatable("adsdrill.jei.category.laser_decomposition"); }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, LaserDecompositionRecipe recipe, @NotNull IFocusGroup focuses) {
        builder.addSlot(RecipeIngredientRole.CATALYST, 48, 2).addItemStack(new ItemStack(AdsDrillBlocks.LASER_DRILL_HEAD.get()));
    ...
    public static List<LaserDecompositionRecipe> getRecipes() {
        return List.of(new LaserDecompositionRecipe(
                new ItemStack(AdsDrillBlocks.ORE_NODE.get()),
                new ItemStack(AdsDrillItems.UNFINISHED_NODE_DATA.get())
        ));
    }
}