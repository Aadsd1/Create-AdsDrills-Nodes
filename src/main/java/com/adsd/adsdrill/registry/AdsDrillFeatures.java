...
import com.adsd.adsdrill.content.worldgen.OreNodeConfiguration;
...
public class AdsDrillFeatures {


    private static final RegistryEntry<Feature<?>, OreNodeFeature> ORE_NODE_FEATURE_ENTRY = AdsDrillAddon.registrate()
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_NODE_CONFIGURED_FEATURE =
            ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(AdsDrillAddon.MOD_ID, "ore_node"));

    public static final ResourceKey<PlacedFeature> ORE_NODE_PLACED_FEATURE =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(AdsDrillAddon.MOD_ID, "ore_node"));
