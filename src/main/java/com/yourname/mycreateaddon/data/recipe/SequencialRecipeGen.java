...
public class SequencialRecipeGen extends SequencedAssemblyRecipeGen {
    ...
    DRILL_CORE=create("drill_core",b->b.require(AllBlocks.BRASS_CASING.asItem())
            .transitionTo(MyAddonItems.INCOMPLETE_DRILL_CORE.get())
            .addOutput(MyAddonBlocks.DRILL_CORE.get(),90)
    ...
    CORE_STEEL_UPGRADE=create("core_steel_upgrade",b->b.require(MyAddonItems.STEEL_INGOT.get())
            .transitionTo(MyAddonItems.INCOMPLETE_DRILL_CORE_STEEL_UPGRADE.get())
            .addOutput(MyAddonItems.DRILL_CORE_STEEL_UPGRADE.get(),88)
            .addOutput(MyAddonItems.RAW_STEEL_CHUNK.get(),3)
            .addOutput(MyAddonItems.RAW_ROSE_GOLD_CHUNK.get(),3)
            ...
            .addStep(DeployerApplicationRecipe::new,rb->rb.require(MyAddonItems.ROSE_GOLD.get()))
            .addStep(DeployerApplicationRecipe::new,rb->rb.require(AllItems.PRECISION_MECHANISM.get()))
            .addStep(PressingRecipe::new,rb->rb)
    ),
    CORE_NETHERITE_UPGRADE=create("core_netherite_upgrade",b->b.require(MyAddonItems.XOMV.get())
            .transitionTo(MyAddonItems.INCOMPLETE_DRILL_CORE_NETHERITE_UPGRADE.get())
            .addOutput(MyAddonItems.DRILL_CORE_NETHERITE_UPGRADE.get(),88)
            .addOutput(MyAddonItems.XOMV.get(),3)
            .addOutput(Items.NETHERITE_INGOT,3)
            .addOutput(AllItems.PRECISION_MECHANISM.get(),2)
            .addOutput(Items.FLINT,1)
            .addOutput(MyAddonItems.KOH_I_NOOR.get(),1)
            ...
            .addStep(DeployerApplicationRecipe::new,rb->rb.require(AllItems.PRECISION_MECHANISM.get()))
            .addStep(DeployerApplicationRecipe::new,rb->rb.require(MyAddonItems.KOH_I_NOOR.get()))
    ...
    LASER_DRILL_HEAD=create("laser_drill_head",b->b.require(AllBlocks.MECHANICAL_DRILL.get())
            .transitionTo(MyAddonItems.INCOMPLETE_LASER_DRILL_HEAD.get())
            .addOutput(MyAddonBlocks.LASER_DRILL_HEAD.get(),90)
            .addOutput(Items.NETHERITE_INGOT,2)
            .addOutput(MyAddonItems.RAW_ROSE_GOLD_CHUNK.get(),2)
            .addOutput(MyAddonItems.RAW_STEEL_CHUNK.get(),2)
            .addOutput(AllItems.PRECISION_MECHANISM.get(),2)
            .addOutput(AllBlocks.MECHANICAL_DRILL.get(),1)
            .addOutput(Items.NETHERITE_SCRAP,1)
            .loops(3)
            .addStep(DeployerApplicationRecipe::new,rb->rb.require(Items.NETHERITE_INGOT))
            .addStep(DeployerApplicationRecipe::new,rb->rb.require(MyAddonItems.STEEL_INGOT.get()))
            .addStep(DeployerApplicationRecipe::new,rb->rb.require(MyAddonItems.ROSE_GOLD.get()))
            .addStep(DeployerApplicationRecipe::new,rb->rb.require(AllItems.PRECISION_MECHANISM.get()))
