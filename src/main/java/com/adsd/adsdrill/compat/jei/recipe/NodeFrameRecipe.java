...
public record NodeFrameRecipe(
    ...
    public static NodeFrameRecipe create(StabilizerCoreItem.Tier tier, Item catalyst1, Item catalyst2) {
        ItemStack core;
        switch (tier) {
            case BRASS -> core = new ItemStack(AdsDrillItems.BRASS_STABILIZER_CORE.get());
            case STEEL -> core = new ItemStack(AdsDrillItems.STEEL_STABILIZER_CORE.get());
            case NETHERITE -> core = new ItemStack(AdsDrillItems.NETHERITE_STABILIZER_CORE.get());
        ...
        return new NodeFrameRecipe(
                ...
                List.of(new ItemStack(AdsDrillItems.UNFINISHED_NODE_DATA.get())),
                new ItemStack(AdsDrillBlocks.ARTIFICIAL_NODE.get())
        );
    }
}