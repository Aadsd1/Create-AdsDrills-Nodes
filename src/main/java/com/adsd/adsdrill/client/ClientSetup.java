...
import com.adsd.adsdrill.content.kinetics.node.OreNodeModelLoader; // 새로 만들 파일
...
@EventBusSubscriber(modid = AdsDrillAddon.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
public class ClientSetup {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        ...
        event.enqueueWork(AdsDrillPartialModels::init);
        ItemProperties.register(
                AdsDrillItems.STEEL_NODE_LOCATOR.get().asItem(),
                ResourceLocation.fromNamespaceAndPath(AdsDrillAddon.MOD_ID, "angle_int"),
        ...
        ItemProperties.register(
                AdsDrillBlocks.DRILL_CORE.get().asItem(),
                ResourceLocation.fromNamespaceAndPath(AdsDrillAddon.MOD_ID, "tier"),
                (stack, level, entity, seed) -> {
    ...
    public static void onModelRegister(ModelEvent.RegisterAdditional event) {
        ...
        event.register(new ModelResourceLocation(AdsDrillPartialModels.SHAFT_FOR_DRILL_LOCATION, "standalone"));
        event.register(new ModelResourceLocation(AdsDrillPartialModels.SHAFT_FOR_MODULE_LOCATION, "standalone"));
        event.register(new ModelResourceLocation(AdsDrillPartialModels.DIAMOND_DRILL_BODY_LOCATION,"standalone"));
        event.register(new ModelResourceLocation(AdsDrillPartialModels.IRON_DRILL_BODY_LOCATION,"standalone"));
        event.register(new ModelResourceLocation(AdsDrillPartialModels.DRILL_TIP_IRON_LOCATION,"standalone"));
        event.register(new ModelResourceLocation(AdsDrillPartialModels.DRILL_TIP_DIAMOND_LOCATION,"standalone"));
        event.register(new ModelResourceLocation(AdsDrillPartialModels.DRILL_TIP_GOLD_LOCATION,"standalone"));
        event.register(new ModelResourceLocation(AdsDrillPartialModels.DRILL_TIP_EMERALD_LOCATION,"standalone"));
        event.register(new ModelResourceLocation(AdsDrillPartialModels.PUMP_HEAD_COG_LOCATION, "standalone"));
        event.register(new ModelResourceLocation(AdsDrillPartialModels.NETHERITE_DRILL_BODY_LOCATION,"standalone"));
        event.register(new ModelResourceLocation(AdsDrillPartialModels.NETHERITE_DRILL_TIP_LOCATION,"standalone"));
    ...
    public static void onModelRegistry(ModelEvent.RegisterGeometryLoaders event) {
        event.register(
                ResourceLocation.fromNamespaceAndPath(AdsDrillAddon.MOD_ID, "ore_node_loader"),
    ...
    public static void onRegisterBlockColors(RegisterColorHandlersEvent.Block event) {
        ...
        event.register(oreNodeColorHandler,
                AdsDrillBlocks.ORE_NODE.get(),
                AdsDrillBlocks.ARTIFICIAL_NODE.get()
        );
    }
