...
public class NodeCombinationCategory implements IRecipeCategory<NodeRecipe> {
    ...
    public static final RecipeType<NodeRecipe> TYPE = RecipeType.create(MyCreateAddon.MOD_ID, "node_combination", NodeRecipe.class);
    ...
    public NodeCombinationCategory(IGuiHelper helper) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(MyCreateAddon.MOD_ID, "textures/gui/jei/node_combination.png");
        background = helper.drawableBuilder(location, 0, 0, 170, 70).setTextureSize(256, 256).build();
        icon = helper.createDrawableItemStack(new ItemStack(MyAddonBlocks.EXPLOSIVE_DRILL_HEAD.get()));
    ...
    @Override public @NotNull Component getTitle() { return Component.translatable("mycreateaddon.jei.category.node_combination"); }
        ...
        builder.addSlot(RecipeIngredientRole.OUTPUT, 140, 26)
                ...
                .addRichTooltipCallback((view, tooltip) -> {
                    if (recipe.chance() < 1.0) {
                        tooltip.add(Component.translatable("mycreateaddon.jei.tooltip.chance", (int)(recipe.chance() * 100))
    ...
    public void draw(@NotNull NodeRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        guiGraphics.drawString(
                ...
                Component.translatable("mycreateaddon.jei.in_cracked_node"),
