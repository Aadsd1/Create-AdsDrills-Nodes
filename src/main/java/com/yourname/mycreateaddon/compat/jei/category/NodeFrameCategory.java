...
import com.yourname.mycreateaddon.compat.jei.recipe.NodeFrameRecipe;
...
public class NodeFrameCategory implements IRecipeCategory<NodeFrameRecipe> {
    ...
    public static final RecipeType<NodeFrameRecipe> TYPE = RecipeType.create(MyCreateAddon.MOD_ID, "node_assembly", NodeFrameRecipe.class);
    ...
    public NodeFrameCategory(IGuiHelper helper) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(MyCreateAddon.MOD_ID, "textures/gui/jei/node_frame_recipe.png");
        ...
        icon = helper.createDrawableItemStack(new ItemStack(MyAddonBlocks.NODE_FRAME.get()));
    ...
    public @NotNull Component getTitle() {
        return Component.translatable("mycreateaddon.jei.category.node_assembly");
    }
    ...
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, @NotNull NodeFrameRecipe recipe, @NotNull IFocusGroup focuses) {
        ...
        for (int row = 0; row < 3; row++) {
            for (int col = 0; col < 3; col++) {
                builder.addSlot(RecipeIngredientRole.INPUT, 18 + col * 18, 50 + row * 18)
                        .addItemStack(new ItemStack(MyAddonItems.UNFINISHED_NODE_DATA.get()))
                        .addRichTooltipCallback((view, tooltip) -> tooltip.add(Component.translatable("mycreateaddon.jei.tooltip.node_data")));
            }
        }
        ...
        builder.addSlot(RecipeIngredientRole.INPUT, 80, 28)
                ...
                .addRichTooltipCallback((view, tooltip) -> tooltip.add(Component.translatable("mycreateaddon.jei.tooltip.stabilizer_core")));

        // Catalyst slots
        builder.addSlot(RecipeIngredientRole.INPUT, 18, 28)
                .addItemStack(recipe.catalyst1())
                .addRichTooltipCallback((view, tooltip) -> tooltip.add(Component.translatable("mycreateaddon.jei.tooltip.catalyst")));
    ...
    public void draw(@NotNull NodeFrameRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        Component text = Component.translatable("mycreateaddon.jei.requires_drill");
        int x = 87;
        int y = 45;
        int maxWidth = 80;
        int color = 0x909090;
    ...
    public static List<NodeFrameRecipe> getRecipes() {
        ...
        recipes.add(NodeFrameRecipe.create(StabilizerCoreItem.Tier.BRASS, MyAddonItems.CINNABAR.get(), MyAddonItems.ULTRAMARINE.get()));
        recipes.add(NodeFrameRecipe.create(StabilizerCoreItem.Tier.STEEL, MyAddonItems.THE_FOSSIL.get(), MyAddonItems.IVORY_CRYSTAL.get()));
        recipes.add(NodeFrameRecipe.create(StabilizerCoreItem.Tier.NETHERITE, MyAddonItems.KOH_I_NOOR.get(), MyAddonItems.THUNDER_STONE.get()));
        return recipes;
    }
}